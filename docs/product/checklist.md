...
O que está **cravado** (decisão) e o que já **roda no mock**. Fila e status: [product-backlog](product-backlog.md). Próximo recorte: [checklist-proximo](../checklist-proximo.md).
...
- [x] Gravidade **Baixa / Média / Alta / Crítica**
