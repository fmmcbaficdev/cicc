...
| 3 | Integração com legado | **PABX** alimenta o CAD nosso (uid, telefone, tronco). AVL e **LPR** no MVP. Ocorrência mora no nosso CAD | PO: criar o CAD do atendente; integrar o PABX a ele | Facial/CPF federado fora. PABX ou LPR atrasado: atendente abre o chamado à mão |
